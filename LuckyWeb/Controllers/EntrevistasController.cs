...
namespace LuckyWeb.Controllers
{
    public class EntrevistasController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["IDuser"] = _context.Users.ToList().Select(r => new SelectListItem { Text =r.Nombre + " " + r.Apellido ,Value= ""+r.IdUser }) ;
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IDentrevistas,IDagenda,IDuser,EstadoEntrevista")] Entrevista entrevista)
        {
            ...
            ViewData["IDuser"] = new SelectList(_context.Users, "IdUser", "Apellido", entrevista.IDuser);
            return View(entrevista);
        }
